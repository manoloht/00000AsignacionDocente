 ...
 */
@Entity
@Table(name = "grupogrande")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Grupogrande.findAll", query = "SELECT g FROM Grupogrande g")
    , @NamedQuery(name = "Grupogrande.findById", query = "SELECT g FROM Grupogrande g WHERE g.id = :id")})
public class Grupogrande implements Serializable {
    ...
    @OneToMany(mappedBy = "idGrupoGrande")
    private Collection<Ggdca> ggdcaCollection;

    public Grupogrande() {
    }

    public Grupogrande(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Grupogrande)) {
            return false;
        }
        Grupogrande other = (Grupogrande) object;
    ...
    public String toString() {
        return "Entities.Grupogrande[ id=" + id + " ]";
    }
